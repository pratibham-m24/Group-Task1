...
import { Container, Header, Item, Input,Icon, Button,Thumbnail,Content,Footer,
          FooterTab,Spinner,Toast, Left,Card,CardItem,Right,Body,Text,List,ListItem } from 'native-base';
...
prodetails:this.props.navigation.state.params.details ,
       pid: this.props.navigation.state.params.proc, userid: global.userid,productid: 1,auth:global.auth
    }
