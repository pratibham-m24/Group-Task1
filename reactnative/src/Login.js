...
<Left>
<Thumbnail style={{paddingLeft:40,height:30, width:30}} source={require("./images/logo.png")} /></Left>   
<Body><Text style={{color:'white',fontWeight: "bold",fontSize: 20}}>Shopmart</Text></Body>            
                         <Right />
          </Header>
